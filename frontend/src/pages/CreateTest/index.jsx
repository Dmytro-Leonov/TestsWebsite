...
const CreateTest = () => {
  ...
  const [numberOfQuestionsErrors, setNumberOfQuestionsErrors] = useState([]);
  ...
  const createTest = async () => {
    try {
      ...
      setNumberOfQuestionsErrors(fields.number_of_questions || []);
      setScoreErrors(fields.score || []);

      if (fields.__all__)
        setTestNameErrors(fields.__all__);
    }
    finally {
      setIsLoading(false);
    }
    ...
    <div className="w-full">
      <form className="flex flex-col items-center gap-4">
        ...
        <div className="w-1/2 min-w-[300px] max-w-[450px]">
          ...
          <DisplayFieldErrors errors={numberOfQuestionsErrors} />
          <TextInput
            type="number"
