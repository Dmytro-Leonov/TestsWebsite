...
urlpatterns = [
    ...
    path("details", GroupDetailsApi.as_view(), name="group-details"),
    path("update/<int:group_id>/", GroupDetailsApi.as_view(), name="group-update"),
    path("delete/<int:group_id>/", GroupUpdateApi.as_view(), name="group-delete"),
