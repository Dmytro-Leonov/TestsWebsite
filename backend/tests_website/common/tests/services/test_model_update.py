...
from tests_website.blog_examples.models import TimestampsOpinionated
from tests_website.common.factories import RandomModelFactory, SimpleModelFactory
...
class ModelUpdateTests(TestCase):
    ...
    def test_model_update_does_not_automatically_update_updated_at_if_kwarg_is_false(self):
        ...
        with patch("tests_website.common.services.timezone.now") as now:
            # We will pass created_at, to trigger actual model update
